      ...
      <div className="resume-container">
        <div className="flex items-center justify-between mb-6">
          ...
          <a 
            ...
            className="px-4 py-2 font-bold text-white rounded bg-primary-500 hover:bg-primary-600"
          >
        ...
        <div className="sr-only">
          ...
          <p>
            Ingénieur DevOps et développeur expérimenté avec plus de 5 ans d'expérience dans le développement web et la gestion de projets.
            Spécialisé dans la conception et l'implémentation de solutions cloud, l'automatisation des déploiements et la gestion des infrastructures.
            Compétences techniques : AWS, Docker, Kubernetes, Terraform, CI/CD, Node.js, React, TypeScript, Python, et plus.
          </p>
        </div>
